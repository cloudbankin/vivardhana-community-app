        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    clientReclientResource: defineResource(apiVer + "/clients/:clientId/:anotherresource", {clientId: '@clientId', anotherresource: '@anotherresource', sqlSearch: '@sqlSearch'}, {
                        getAllClients: {method: 'GET', params: {limit: 1000, sqlSearch: '@sqlSearch'}},
                        getAllClientsWithoutLimit: {method: 'GET', params: {}},
                        getClientClosureReasons: {method: 'GET', params: {}},
                        getAllClientDocuments: {method: 'GET', params: {}, isArray: true},
                    ...
                    clientAdvanceTemplateResource: defineResource(apiVer + "/clients/advanceTemplate", {}, {
                        get: {method: 'GET', params: {}}
                    }),
                    ...
                    clientsearch: defineResource(apiVer + "/clients", {templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        search: {method: 'GET', params: {}, isArray: true}
                    }),
                    advanceSearch: defineResource(apiVer + "/clients/advanceSearch", {templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        search: {method: 'GET', params: {}}
                    }),
                    advanceSearchGroup: defineResource(apiVer + "/groups/advanceSearch", {templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        search: {method: 'GET', params: {}}
                    }),
                    advanceSearchCenter: defineResource(apiVer + "/centers/advanceSearch", {templateResource: '@templateResource'}, {
                        get: {method: 'GET', params: {}},
                        search: {method: 'GET', params: {}}
                    }),
                    ...
                    bankRemittanceResource: defineResource(apiVer + "/bankRemittance", {}, {
                    ...
                    bankRemittanceTemplateResource: defineResource(apiVer + "/bankRemittance/template", {}, {
                        get: {method: 'GET', params: {}},
                    }),
                    bankRemittanceSearchedResource: defineResource(apiVer + "/bankRemittance/search", {bankId:'@bankId',startDate:'@startDate',endDate:'@endDate'}, {
                        search:{method:'GET', params:{},isArray : true}
                    }),
                    bankRemittanceDownloadResource: defineResource(apiVer + "/bankRemittance/download", {selectedLoans:'@selectedLoans',bankId:'@bankId'}, {
                        download:{method:'GET', params:{}}
                    }),
                    bankRemittanceGeneratedLoansResource: defineResource(apiVer + "/bankRemittance/generatedLoans", {}, {
                        getAllApprovedLoans:{method:'GET', params:{},isArray : true}
                    }),
